...
В целом, результат лабораторной работы положителен. Тестами успешно проверяются самые важные связи между интерфейсом и базой данных, а также в процессе работы были получены полезные знания по работе с tkinter, определению фикстур, и структуризации проектов в python.
